...
insert into employee(NAME,ADDRESS,ni_num,PHONE,emp_id,join_date,branch_id,position,supervisor_id) values(
	name_type(
		'Mrs','Alisa','Smith'),
	address_type(
		'Colinton',
...
INSERT INTO customer (name, address, ni_num, phone, cust_id) VALUES ( 
    name_Type(
        'Mr', 
        'Jack',
        'Smith'), 
...
INSERT INTO customer (name, address, ni_num, phone, cust_id) VALUES ( 
    ...
    address_Type(
        ...
        'EH115ER'), 
    'N1040',
    phone_type_table(phone_nested('Mobile','0750234252'),phone_nested('Mobile','07952352351'),phone_nested('Home',null)),
    '1041'
);
...
INSERT INTO customer (name, address, ni_num, phone, cust_id) VALUES ( 
    ...
    address_Type(
        ...
        'EH113RR'), 
    'N1041',
    phone_type_table(phone_nested('Mobile','07504512412'),phone_nested('Mobile','07541243314'),phone_nested('Home',null)),
    '1042'
);
